...
const ShopPage = () => {
    const { fetchProductBySubcategory, products } = productStore();
    ...
    useEffect(() => {
        if (category && subCategory) {
            fetchProductBySubcategory(category, subCategory)
        }
    }, [category, subCategory, fetchProductBySubcategory]);
    return (
                                ...
                                <div className="p-2 space-y-1">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2.5 rounded flex items-center justify-between ${sortOption === option.value ? 'bg-amber-50 text-amber-700' : 'text-gray-700 hover:bg-gray-50'
                                                }`}
                                        >
